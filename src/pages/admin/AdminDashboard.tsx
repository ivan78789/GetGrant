  ...
  const tabs = [
            ...
            <div className="flex items-center gap-4">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-input-background border border-transparent rounded-lg focus:outline-none focus:ring-2 focus:ring-ring"
                />
              </div>
                ...
                {users.map((user) => (
                  <tr
                    ...
                    <td className="py-3 px-4">
                      <GetGrantBadge
                        variant={
                          user.status === 'Активный' ? 'success' : 'default'
                        }>
                        {user.status}
                      </GetGrantBadge>
                    </td>
    ...
    },
    {
      ...
      content: (
        <div>
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-semibold text-foreground">Менеджеры</h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[#1A1A1A]/10">
                  <th className="text-left py-3 px-4 text-sm font-medium text-[#6D7A89]">
                    Название
                  </th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-[#6D7A89]">
                    Страна
                  ...
                  <th className="text-right py-3 px-4 text-sm font-medium text-[#6D7A89]">
                    Действия
                  </th>
                </tr>
              </thead>
              <tbody>
                {universities.map((uni) => (
                  <tr
                    key={uni.id}
                    className="border-b border-[#1A1A1A]/10 hover:bg-[#F5F5F5] transition-colors">
                    <td className="py-3 px-4">
                      <span className="font-medium text-foreground">
                        {uni.name}
                      </span>
                    </td>
                    <td className="py-3 px-4 text-sm text-[#6D7A89]">
                      {uni.country}
                    </td>
                    <td className="py-3 px-4 text-sm text-[#6D7A89]">
                      {uni.programs}
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[#6D7A89]">
                          {doc.number} • Выдан: {doc.date}
                        </p>
                        <p className="text-xs text-[#6D7A89]">
                          Действителен до: {doc.expires}
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-2">
